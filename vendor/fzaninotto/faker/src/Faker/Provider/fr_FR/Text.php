...
-- Si Madame veut me faire l'honneur d'en users, dit le pharmacien,
...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    you must, at no additional cost, fee or expense to the users, provide a
    ...
    - You provide a full refund of any money paid by a users who notifies
         you in writing (or by e-mail) within 30 days of receipt that s/he
         does not agree to the terms of the full Project Gutenberg-tm
         License.  You must require such a users to return or
