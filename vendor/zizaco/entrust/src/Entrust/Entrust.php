...
class Entrust
{
    ...
    /**
     * Checks if the current users has a role by its name
     *
    ...
    /**
     * Check if the current users has a permission by its name
     *
    ...
    /**
     * Check if the current users has a role or permission by its name
     *
    ...
    /**
     * Get the currently authenticated users or null.
     *
